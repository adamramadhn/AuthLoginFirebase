...
import com.example.firebaseauth.databinding.FragmentChangePasswordBinding
                ...
                btnUpdate.setOnClickListener {
                    ...
                    userData.let {
                        userData?.updatePassword(newPassword)?.addOnCompleteListener {
                            if(it.isSuccessful){
                                val actionPasswordChange = ChangePasswordFragmentDirections.actionPasswordChanged()
